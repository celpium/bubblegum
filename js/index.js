...
$(document).ready(function(){
    ...
    // var work = $('li.work>a').get();
    
    // for (var i = 0; i < work.length; i ++) {
    //     work[i].mouseover(function(){
    //         $('div.obje').css('background', 'url(' + obje[i] + ') no-repeat center top');
    //         $('div.obje').css('background-size', 'contain');
    //     });
    //     work[i].mouseout(function(){
    //         $('div.obje').css('background', 'url(' + gif + ') no-repeat center top');
    //         $('div.obje').css('background-size', 'contain');
    //     });
    // }
    ...
    // if(isTouchDevice){
    //     objeDiv[0].on('touchstart', function(){
    //         $('div.obje').css('background', 'url(' + obje[0] + ') no-repeat center top');
    //         $('div.obje').css('background-size', 'contain');
    //     });
    //     objeDiv[0].on('touchend', function(){
    //         $('div.obje').css('background', 'url(' + gif + ') no-repeat center top');
    //         $('div.obje').css('background-size', 'contain');
    //     });
    // }else{
    //     objeDiv[0].hover(function(){
    //         $('div.obje').css('background', 'url(' + obje[0] + ') no-repeat center top');
    //         $('div.obje').css('background-size', 'contain');
    //     }, function(){
    //         $('div.obje').css('background', 'url(' + gif + ') no-repeat center top');
