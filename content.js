...
window.addEventListener("resize", contentMarginControl);
function contentMarginControl(){
    if(window.innerWidth > 1200){
        $('div.marginMobile').css('display', 'none');
        $('div.marginPC').css('display', 'block');
    }else if(window.innerWidth <= 1200){
        $('div.marginMobile').css('display', 'block');
        $('div.marginPC').css('display', 'none');
    }
}
